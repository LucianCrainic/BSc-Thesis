...
\chapter{Introduction} \label{chap:introduction}
   ...
   \section{Objectives} 
      ...
      In this thesis work the task that is set to be accomplished is to \textbf{classify movements using Kinect skeleton data}, this task is divided into several objectives that would help to accomplish it. Objectives are described as follows:
